...
Player.prototype.setVolume = function(volume){
	...
	this.voiceConnection.setVolume(Math.floor(volume/100));
	return this.voiceConnection.volume;
}


Player.prototype.getVolume = function(){
	return this.voiceConnection.volume*100;
}
...
Player.prototype.addVolume = function(volume){
	...
	this.voiceConnection.setVolume(Math.floor((volume + this.voiceConnection.volume)/100));
	return this.voiceConnection.volume;
}
